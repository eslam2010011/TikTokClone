package com.tiktokclone.record.camera;
...
import com.tiktokclone.record.interfaces.ICamera;
...
public class CameraController implements ICamera {
    ...
    public void onFocus(Point point, Camera.AutoFocusCallback callback) {
        ...
        //再次进行转换
        point.x= (int) (((float)point.x)/ App.Companion.getScreenWidth()*2000-1000);
        point.y= (int) (((float)point.y)/ App.Companion.screenHeight()*2000-1000);
