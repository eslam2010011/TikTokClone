package com.tiktokclone.record.ui;
...
import com.tiktokclone.record.other.MagicFilterFactory;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(App.Companion.getContext());
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                locked = true;
                downX = -1;
                if (offset > App.Companion.getScreenWidth() / 3) {
                    scroller.startScroll(offset, 0, App.Companion.getScreenWidth() - offset, 0, 100 * (1 - offset / App.Companion.getScreenWidth()));
                    needSwitch = true;
                } else {
                    scroller.startScroll(offset, 0, -offset, 0, 100 * (offset / App.Companion.getScreenWidth()));
                    needSwitch = false;
                }
                break;
        }
